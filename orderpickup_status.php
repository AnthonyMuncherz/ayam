...
<div class="confirmation-box">
  ...
  <div class="info-line"><strong>Pickup at:</strong> <?= htmlspecialchars($order['outlet_name'] ?? 'Unknown Outlet') ?></div>
  <div class="info-line"><strong>Payment Method:</strong> <?= htmlspecialchars($order['payment_method'] ?? 'Unknown') ?></div>
